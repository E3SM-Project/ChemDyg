...
plt.title('Latitude-time spatial pattern of TCO (DU) from MSR\n ')
plt.ylim(-60,60)
plt.xlim(-14,14)
...
plt.title('Latitude-time spatial pattern of TCO (DU) from E3SM\n ')
plt.ylim(-60,60)
plt.xlim(-14,14)
plt.xlabel('Time (month)')
plt.ylabel('Latitude')
...
##
plt.subplot(4, 2, 1)
plot3 = plt.contourf(o3_lev_trop['time'], o3_lev_trop['lev'], o3_lev_trop.transpose("lev","time"),levels=np.linspace(-5e-7,5e-7,12),cmap = 'RdBu_r',extend='both')
plt.title('Vertical cross-section of O3 (ppm) from CMZM (15S-15N)\n ')
plt.ylim(100,1)
plt.xlim(-14,14)
plt.yscale('log')
plt.xlabel('Time (month)')
plt.ylabel('Pressure (hPa)')
cross_colorbar = fig.colorbar(plot3, ticks=np.linspace(-5e-7,5e-7,12))
##
plt.subplot(4, 2, 2)
plot4 = plt.contourf(o3_lev_trop_sim['time'], o3_lev_trop_sim['lev'], o3_lev_trop_sim.transpose("lev","time"),levels=np.linspace(-5e-7,5e-7,12),cmap = 'RdBu_r',extend='both')
plt.title('Vertical cross-section of O3 (ppm) from E3SM (15S-15N)\n ')
plt.ylim(100,1)
plt.xlim(-14,14)
plt.yscale('log')
plt.xlabel('Time (month)')
plt.ylabel('Pressure (hPa)')
cross_colorbar = fig.colorbar(plot4, ticks=np.linspace(-5e-7,5e-7,12))
##
plt.subplot(4, 2, 3)
plot3 = plt.contourf(o3_lev_Next['time'], o3_lev_Next['lev'], o3_lev_Next.transpose("lev","time"),levels=np.linspace(-5e-7,5e-7,12),cmap = 'RdBu_r',extend='both')
plt.title('Vertical cross-section of O3 (ppm) from CMZM (30N-60N)\n ')
plt.ylim(100,1)
plt.xlim(-14,14)
plt.yscale('log')
plt.xlabel('Time (month)')
...
##
plt.subplot(4, 2, 4)
plot3 = plt.contourf(o3_lev_Next_sim['time'], o3_lev_Next_sim['lev'], o3_lev_Next_sim.transpose("lev","time"),levels=np.linspace(-5e-7,5e-7,12),cmap = 'RdBu_r',extend='both')
plt.title('Vertical cross-section of O3 (ppm) from E3SM (30N-60N)\n ')
plt.ylim(100,1)
plt.xlim(-14,14)
plt.yscale('log')
plt.xlabel('Time (month)')
...
##
plt.subplot(4, 2, 5)
plot3 = plt.contourf(o3_lev_Sext['time'], o3_lev_Sext['lev'], o3_lev_Sext.transpose("lev","time"),levels=np.linspace(-5e-7,5e-7,12),cmap = 'RdBu_r',extend='both')
plt.title('Vertical cross-section of O3 (ppm) from CMZM (30S-60S)\n ')
plt.ylim(100,1)
plt.xlim(-14,14)
plt.yscale('log')
plt.xlabel('Time (month)')
...
###
plt.subplot(4, 2, 6)
plot3 = plt.contourf(o3_lev_Sext_sim['time'], o3_lev_Sext_sim['lev'], o3_lev_Sext_sim.transpose("lev","time"),levels=np.linspace(-5e-7,5e-7,12),cmap = 'RdBu_r',extend='both')
plt.title('Vertical cross-section of O3 (ppm) from E3SM (30S-60S)\n ')
plt.ylim(100,1)
plt.xlim(-14,14)
plt.yscale('log')
plt.xlabel('Time (month)')
...
##
plt.subplot(3, 3, 1)
plot1 = plt.contourf(ss_t_lev_trop['time'], ss_t_lev_trop['lev'], ss_t_lev_trop.transpose("lev","time"),levels=np.linspace(-2,2,12),cmap = 'RdBu_r',extend='both')
plt.title('Vertical cross-section of temperature (K) (15S-15N)\n ')
plt.ylim(100,1)
plt.xlim(-14,14)
plt.yscale('log')
plt.xlabel('Time (month)')
plt.ylabel('Pressure (hPa)')
cross_colorbar = fig.colorbar(plot1, ticks=np.linspace(-2,2,12))
##
plt.subplot(3, 3, 2)
plot2 = plt.contourf(ss_o3_lev_trop['time'], ss_o3_lev_trop['lev'], ss_o3_lev_trop.transpose("lev","time"),levels=np.linspace(-5e-7,5e-7,12),cmap = 'RdBu_r',extend='both')
plt.title('Vertical cross-section of Steady State O3 (ppm) (15S-15N)\n ')
plt.ylim(100,1)
plt.xlim(-14,14)
plt.yscale('log')
plt.xlabel('Time (month)')
plt.ylabel('Pressure (hPa)')
cross_colorbar = fig.colorbar(plot2, ticks=np.linspace(-5e-7,5e-7,12))
##
plt.subplot(3, 3, 3)
plot3 = plt.contourf(o3_lev_trop_sim['time'], o3_lev_trop_sim['lev'], o3_lev_trop_sim.transpose("lev","time"),levels=np.linspace(-5e-7,5e-7,12),cmap = 'RdBu_r',extend='both')
plt.title('Vertical cross-section of E3SM O3 (ppm) (15S-15N)\n ')
plt.ylim(100,1)
plt.xlim(-14,14)
plt.yscale('log')
plt.xlabel('Time (month)')
...
##
plt.subplot(3, 3, 4)
plot4 = plt.contourf(ss_t_lev_Next['time'], ss_t_lev_Next['lev'], ss_t_lev_Next.transpose("lev","time"),levels=np.linspace(-2,2,12),cmap = 'RdBu_r',extend='both')
plt.title('Vertical cross-section of temperature (K) (30N-60N)\n ')
plt.ylim(100,1)
plt.xlim(-14,14)
plt.yscale('log')
plt.xlabel('Time (month)')
plt.ylabel('Pressure (hPa)')
cross_colorbar = fig.colorbar(plot4, ticks=np.linspace(-2,2,12))
##
plt.subplot(3, 3, 5)
plot5 = plt.contourf(ss_o3_lev_trop['time'], ss_o3_lev_trop['lev'], ss_o3_lev_trop.transpose("lev","time"),levels=np.linspace(-5e-7,5e-7,12),cmap = 'RdBu_r',extend='both')
plt.title('Vertical cross-section of Steady State O3 (ppm) (30N-60N)\n ')
plt.ylim(100,1)
plt.xlim(-14,14)
plt.yscale('log')
plt.xlabel('Time (month)')
plt.ylabel('Pressure (hPa)')
cross_colorbar = fig.colorbar(plot5, ticks=np.linspace(-5e-7,5e-7,12))
##

plt.subplot(3, 3, 6)
plot6 = plt.contourf(o3_lev_Next_sim['time'], o3_lev_Next_sim['lev'], o3_lev_Next_sim.transpose("lev","time"),levels=np.linspace(-5e-7,5e-7,12),cmap = 'RdBu_r',extend='both')
plt.title('Vertical cross-section of E3SM O3 (ppm) (30N-60N)\n ')
plt.ylim(100,1)
plt.xlim(-14,14)
plt.yscale('log')
plt.xlabel('Time (month)')
plt.ylabel('Pressure (hPa)')
cross_colorbar = fig.colorbar(plot6, ticks=np.linspace(-5e-7,5e-7,12))
##
plt.subplot(3, 3, 7)
plot7 = plt.contourf(ss_t_lev_Sext['time'], ss_t_lev_Sext['lev'], ss_t_lev_Sext.transpose("lev","time"),levels=np.linspace(-2,2,12),cmap = 'RdBu_r',extend='both')
plt.title('Vertical cross-section of temperature (K) (30S-60S)\n ')
plt.ylim(100,1)
plt.xlim(-14,14)
plt.yscale('log')
plt.xlabel('Time (month)')
plt.ylabel('Pressure (hPa)')
cross_colorbar = fig.colorbar(plot7, ticks=np.linspace(-2,2,12))
##
plt.subplot(3, 3, 8)
plot8 = plt.contourf(ss_o3_lev_Sext['time'], ss_o3_lev_Sext['lev'], ss_o3_lev_Sext.transpose("lev","time"),levels=np.linspace(-5e-7,5e-7,12),cmap = 'RdBu_r',extend='both')
plt.title('Vertical cross-section of Steady State O3 (ppm) (30S-60S)\n ')
plt.ylim(100,1)
plt.xlim(-14,14)
plt.yscale('log')
plt.xlabel('Time (month)')
plt.ylabel('Pressure (hPa)')
cross_colorbar = fig.colorbar(plot8, ticks=np.linspace(-5e-7,5e-7,12))
##
plt.subplot(3, 3, 9)
plot9 = plt.contourf(o3_lev_Sext_sim['time'], o3_lev_Sext_sim['lev'], o3_lev_Sext_sim.transpose("lev","time"),levels=np.linspace(-5e-7,5e-7,12),cmap = 'RdBu_r',extend='both')
plt.title('Vertical cross-section of E3SM O3 (ppm) (30S-60S)\n ')
plt.ylim(100,1)
plt.xlim(-14,14)
plt.yscale('log')
plt.xlabel('Time (month)')
plt.ylabel('Pressure (hPa)')
cross_colorbar = fig.colorbar(plot9, ticks=np.linspace(-5e-7,5e-7,12))
